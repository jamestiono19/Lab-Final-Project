	...
	while(gameOn == 'y'){
		...
		while(1){
			if(menuChoice != 1 && menuChoice != 2 && menuChoice != 3 && menuChoice != 4 && menuChoice != 5){
				switch(choiceTries % 5){
					...
					case 1: 
						printf("Please try 1, 2, 3, or 4. There are only 4 options, Captain. (1, 2, 3, 4, or 5): ");
						choiceTries++;
						break;
						
					case 2: 
						printf("Captain, please... (1, 2, 3, 4, or 5): ");
						choiceTries++;
						break;
						
					case 3: 
						printf("Captain... (1, 2, 3, 4, or 5): ");
						choiceTries++;
						break;
		...
		switch(menuChoice){
		    case 1: 
				...
				point = 0;
				printf("Do you want to go to the menu? (y/n) ");
				printf("(Not going to the menu means exitting the program): ");
				while (1) {
					scanf(" %c", &gameOn); getchar();
